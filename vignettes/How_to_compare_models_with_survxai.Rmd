...
We base models on five variables from `pbc` data set. They are `age`, `treatment`, `stage`, `sex`, and `bili`. For this purpouse we create a new data set `pbc_smaller`. We also change `days` for `years`.
