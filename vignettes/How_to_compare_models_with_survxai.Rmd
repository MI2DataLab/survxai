...
```{r}
plot(cp_cph, scale_type = "gradient", col_scale = c("red", "blue"))

plot(cp_rf, scale_type = "gradient", col_scale = c("red", "blue"))
plot(cp_reg, scale_type = "gradient", col_scale = c("red", "blue"))
```
...
```{r}
plot(broken_prediction_cph, col_scale = c("red", "blue"), lines_type = 2)
plot(broken_prediction_rf, col_scale = c("red", "blue"), lines_type = 2)
plot(broken_prediction_reg, col_scale = c("red", "blue"), lines_type = 2)
```
